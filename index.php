...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Omnifood is a premium foods selivery service with the mission to bring affordable meals to as many people as possible">
        ...
        <section class="section-steps" id="works">
            ...
            <div class="row">
                <div class="col span-1-of-2 steps-box">
                    <img src="resources/img/app-iPhone.png" alt="Omniphood app on iphone" class="app-screen js--wp-2">
                </div>
                <div class="col span-1-of-2 steps-box">
        ...
        <section class="section-testimonials">
            ...
            <div class="row">
                <div class="col span-1-of-3">
                    ...
                    <cite><img src="resources/img/customer-1.jpg" alt="Albert Duncan">Alberto Duncan</cite>
                </div>
                <div class="col span-1-of-3">
                    <blockquote>
                    ...
                    <div class="plan-box">
                        ...
                        <div>
                            <ul>
                                ...
                                <li><i class="ion-ios-close icon-small"></i>Access to newest creations</li>
                                <li><i class="ion-ios-checkmark icon-small"></i>Free delivery</li>
                            </ul>
                        </div>
                        <div>
